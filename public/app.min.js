    ...
    if (publicPlaylistsHeader) {
      ...
      publicPlaylistsHeader.addEventListener('click', function(e) {
        ...
        if (publicPlaylistsPanel) {
          const wasCollapsed = publicPlaylistsPanel.classList.contains('collapsed');
          publicPlaylistsPanel.classList.toggle('collapsed');
          console.log('[Accordion] Toggled collapsed class, now:', publicPlaylistsPanel.classList.contains('collapsed') ? 'COLLAPSED' : 'EXPANDED');
        } else {
