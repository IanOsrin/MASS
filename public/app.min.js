    ...
    function updateNowPlayingUI(){
      ...
      if (!meta) {
        ...
        // Show albums grid when no track is playing
      ...
      // Hide albums grid when a track is playing
...
function hideLanding(){ /* no-op: placeholder removed */ }function doSearch(q, options = {}){
    ...
    async function openTracksModal(album, sourceCard=null){
      ...
      if (fullAlbum.picture) {
        ...
        // Set large album sleeve background
        if (modalAlbumSleeve) {
          modalAlbumSleeve.style.backgroundImage = `url(/api/container?u=${encodeURIComponent(fullAlbum.picture)})`;
        }
      } else {
        ...
        modalCover.appendChild(wrap);
        modalCover.style.display = 'block';
        // Set large album sleeve background to placeholder
        if (modalAlbumSleeve) {
          modalAlbumSleeve.style.backgroundImage = 'url(/img/placeholder.png)';
        }
      }
