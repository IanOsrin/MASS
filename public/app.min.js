    ...
    async function loadFeaturedAlbums(options = {}) {
      ...
      console.log('[loadFeaturedAlbums] Disabled - skipping featured albums');
      // Featured albums temporarily disabled
      return;
...
function hideLanding(){ /* no-op: placeholder removed */ }function doSearch(q, options = {}){
    ...
    if (exploreGenresEl){
      ...
      for (const genre of genres) {
        ...
        btn.addEventListener('click', () => handleExploreSearch(genre, { genre }));
